...
# Import modules
try:
    from old_reference.vision import call_roboflow_sdk, call_local_server, class_to_id
...
Examples:
  ...
  python pc_client_full.py --rpi-host 192.168.1.100 --max-retries 2
    ...
    global VISION_SERVER_URL, MAX_RETRIES, TASK_TIMEOUTS
    VISION_SERVER_URL = args.vision_server
    MAX_RETRIES = args.max_retries
    TASK_TIMEOUTS = args.timeout
